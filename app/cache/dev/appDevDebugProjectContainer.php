...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.db_curriculo_connection' => 'getDoctrine_Dbal_DbCurriculoConnectionService',
            'doctrine.dbal.db_hoja_vida_connection' => 'getDoctrine_Dbal_DbHojaVidaConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.db_curriculo' => 'getDoctrine_Dbal_Logger_Profiling_DbCurriculoService',
            'doctrine.dbal.logger.profiling.db_hoja_vida' => 'getDoctrine_Dbal_Logger_Profiling_DbHojaVidaService',
            'doctrine.orm.entity_db_curriculo_entity_manager' => 'getDoctrine_Orm_EntityDbCurriculoEntityManagerService',
            'doctrine.orm.entity_db_curriculo_manager_configurator' => 'getDoctrine_Orm_EntityDbCurriculoManagerConfiguratorService',
            'doctrine.orm.entity_db_hoja_vida_entity_manager' => 'getDoctrine_Orm_EntityDbHojaVidaEntityManagerService',
            'doctrine.orm.entity_db_hoja_vida_manager_configurator' => 'getDoctrine_Orm_EntityDbHojaVidaManagerConfiguratorService',
            ...
            'ps_pdf.cache' => 'getPsPdf_CacheService',
            'ps_pdf.facade' => 'getPsPdf_FacadeService',
            'ps_pdf.facade_builder' => 'getPsPdf_FacadeBuilderService',
            'ps_pdf.listener' => 'getPsPdf_ListenerService',
            ...
            'security.firewall.map.context.frontend' => 'getSecurity_Firewall_Map_Context_FrontendService',
            'security.rememberme.response_listener' => 'getSecurity_Rememberme_ResponseListenerService',
            'security.secure_random' => 'getSecurity_SecureRandomService',
            'security.user.provider.concrete.usuarios' => 'getSecurity_User_Provider_Concrete_UsuariosService',
        ...
        $this->aliases = array(
            'database_connection' => 'doctrine.dbal.db_curriculo_connection',
            'debug.templating.engine.twig' => 'templating',
            'doctrine.orm.entity_manager' => 'doctrine.orm.entity_db_curriculo_entity_manager',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/hoja_vida/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/hoja_vida/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/hoja_vida/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/hoja_vida/app/Resources');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('DB_HOJA_VIDA' => 'doctrine.dbal.DB_HOJA_VIDA_connection', 'DB_CURRICULO' => 'doctrine.dbal.DB_CURRICULO_connection'), array('ENTITY_DB_HOJA_VIDA' => 'doctrine.orm.ENTITY_DB_HOJA_VIDA_entity_manager', 'ENTITY_DB_CURRICULO' => 'doctrine.orm.ENTITY_DB_CURRICULO_entity_manager'), 'DB_CURRICULO', 'ENTITY_DB_CURRICULO');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.db_curriculo_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_DbCurriculoConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.db_curriculo'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.db_curriculo_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'curriculo', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.dbal.db_hoja_vida_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return stdClass A stdClass instance.
     */
    protected function getDoctrine_Dbal_DbHojaVidaConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.db_hoja_vida'));

        $b = new \Doctrine\DBAL\Configuration();
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.db_hoja_vida_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'hoja_vida', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }

    /**
     * Gets the 'doctrine.orm.entity_db_curriculo_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_EntityDbCurriculoEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_ENTITY_DB_CURRICULO_42f81ed2dd763fad7a794b667ff954a9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_ENTITY_DB_CURRICULO_42f81ed2dd763fad7a794b667ff954a9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_ENTITY_DB_CURRICULO_42f81ed2dd763fad7a794b667ff954a9');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\hoja_vida\\src\\proyectos\\curriculoBundle\\Entity')), 'proyectos\\curriculoBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('curriculoBundle' => 'proyectos\\curriculoBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/wamp/www/hoja_vida/app/cache/dev/doctrine/orm/Proxies');
        ...
        $this->services['doctrine.orm.entity_db_curriculo_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.db_curriculo_connection'), $e);

        $this->get('doctrine.orm.entity_db_curriculo_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.entity_db_curriculo_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Orm_EntityDbCurriculoManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.entity_db_curriculo_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }

    /**
     * Gets the 'doctrine.orm.entity_db_hoja_vida_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_EntityDbHojaVidaEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_ENTITY_DB_HOJA_VIDA_42f81ed2dd763fad7a794b667ff954a9');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_ENTITY_DB_HOJA_VIDA_42f81ed2dd763fad7a794b667ff954a9');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_ENTITY_DB_HOJA_VIDA_42f81ed2dd763fad7a794b667ff954a9');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\hoja_vida\\src\\proyectos\\hojaVidaBundle\\Entity')), 'proyectos\\hojaVidaBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('hojaVidaBundle' => 'proyectos\\hojaVidaBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        ...
        $this->services['doctrine.orm.entity_db_hoja_vida_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.db_hoja_vida_connection'), $e);

        $this->get('doctrine.orm.entity_db_hoja_vida_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.entity_db_hoja_vida_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_EntityDbHojaVidaManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.entity_db_hoja_vida_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/hoja_vida/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/hoja_vida/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('DB_HOJA_VIDA', $this->get('doctrine.dbal.logger.profiling.db_hoja_vida'));
        $d->addLogger('DB_CURRICULO', $this->get('doctrine.dbal.logger.profiling.db_curriculo'));

        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/hoja_vida/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    /**
     * Gets the 'ps_pdf.cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return PHPPdf\Cache\CacheImpl A PHPPdf\Cache\CacheImpl instance.
     */
    protected function getPsPdf_CacheService()
    {
        return $this->services['ps_pdf.cache'] = new \PHPPdf\Cache\CacheImpl('File', array('cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev'));
    }

    /**
     * Gets the 'ps_pdf.facade' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return PHPPdf\Core\Facade A PHPPdf\Core\Facade instance.
     */
    protected function getPsPdf_FacadeService()
    {
        return $this->services['ps_pdf.facade'] = $this->get('ps_pdf.facade_builder')->build();
    }

    /**
     * Gets the 'ps_pdf.facade_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return PHPPdf\Core\FacadeBuilder A PHPPdf\Core\FacadeBuilder instance.
     */
    protected function getPsPdf_FacadeBuilderService()
    {
        $this->services['ps_pdf.facade_builder'] = $instance = call_user_func(array('PHPPdf\\Core\\FacadeBuilder', 'create'), new \PHPPdf\Core\Configuration\LoaderImpl(NULL, NULL, NULL, NULL));
        ...
        $instance->setCache('File', array('cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev'));
    ...
    /**
     * Gets the 'ps_pdf.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Ps\PdfBundle\EventListener\PdfListener A Ps\PdfBundle\EventListener\PdfListener instance.
     */
    protected function getPsPdf_ListenerService()
    {
        return $this->services['ps_pdf.listener'] = new \Ps\PdfBundle\EventListener\PdfListener($this->get('ps_pdf.facade_builder'), $this->get('annotation_reader'), new \Ps\PdfBundle\Reflection\Factory(), $this->get('templating'), $this->get('ps_pdf.cache'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/hoja_vida/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('proyectos\\curriculoBundle\\Entity\\SUsuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => false, 2 => 0))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.frontend' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/*'))), $this->get('event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.frontend' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/curriculo/*');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registro/*');

        $i = new \Symfony\Component\Security\Http\AccessMap();
        $i->add($g, array(0 => 'ROLE_USUARIO'), NULL);
        $i->add($h, array(0 => 'ROLE_USUARIO'), NULL);

        $j = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '_logout'));
        $k->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('default_target_path' => '_lista_usuarios', 'login_path' => '_login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $l->setProviderKey('frontend');

        return $this->services['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.usuarios')), 'frontend', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'frontend', $l, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('login_path' => '_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '52466ad5465a9', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'frontend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, '_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/hoja_vida/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/hoja_vida/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/wamp/www/hoja_vida/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/hoja_vida/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/hoja_vida/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('frontend', '_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/hoja_vida/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/hoja_vida/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\src\\proyectos\\hojaVidaBundle/Resources/views', 'hojaVida');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\src\\proyectos\\curriculoBundle/Resources/views', 'curriculo');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\src\\proyectos\\AccesoBundle/Resources/views', 'Acceso');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\psliwa\\pdf-bundle\\Ps\\PdfBundle/Resources/views', 'PsPdf');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/hoja_vida/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/hoja_vida/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/hoja_vida/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.db_curriculo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_DbCurriculoService()
    {
        return $this->services['doctrine.dbal.logger.profiling.db_curriculo'] = new \Doctrine\DBAL\Logging\DebugStack();
    }

    /**
     * Gets the 'doctrine.dbal.logger.profiling.db_hoja_vida' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_DbHojaVidaService()
    {
        return $this->services['doctrine.dbal.logger.profiling.db_hoja_vida'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.usuarios'), new \Symfony\Component\Security\Core\User\UserChecker(), 'frontend', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('52466ad5465a9')), true);
    ...
    /**
     * Gets the 'security.user.provider.concrete.usuarios' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UsuariosService()
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'proyectos\\curriculoBundle\\Entity\\SUsuario', 'dni', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/hoja_vida/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/hoja_vida/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/hoja_vida/app/logs',
            'kernel.bundles' => array(
                ...
                'hojaVidaBundle' => 'proyectos\\hojaVidaBundle\\hojaVidaBundle',
                'curriculoBundle' => 'proyectos\\curriculoBundle\\curriculoBundle',
                'AccesoBundle' => 'proyectos\\AccesoBundle\\AccesoBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'hoja_vida',
            'database_user' => 'root',
            'database_password' => NULL,
            'database_host2' => '127.0.0.1',
            'database_port2' => NULL,
            'database_name2' => 'curriculo',
            'database_user2' => 'root',
            ...
            'debug.container.dump' => 'C:/wamp/www/hoja_vida/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/hoja_vida/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\hoja_vida\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/hoja_vida/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/hoja_vida/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/hoja_vida/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/hoja_vida/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/hoja_vida/app/../web',
            'assetic.write_to' => 'C:/wamp/www/hoja_vida/app/../web',
            ...
            'doctrine.entity_managers' => array(
                'ENTITY_DB_HOJA_VIDA' => 'doctrine.orm.ENTITY_DB_HOJA_VIDA_entity_manager',
                'ENTITY_DB_CURRICULO' => 'doctrine.orm.ENTITY_DB_CURRICULO_entity_manager',
            ),
            'doctrine.default_entity_manager' => 'ENTITY_DB_CURRICULO',
            'doctrine.dbal.connection_factory.types' => array(

            ),
            'doctrine.connections' => array(
                'DB_HOJA_VIDA' => 'doctrine.dbal.DB_HOJA_VIDA_connection',
                'DB_CURRICULO' => 'doctrine.dbal.DB_CURRICULO_connection',
            ),
            'doctrine.default_connection' => 'DB_CURRICULO',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev/doctrine/orm/Proxies',
            ...
            'ps_pdf.cache.options' => array(
                'cache_dir' => 'C:/wamp/www/hoja_vida/app/cache/dev',
            ),
