    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/registro')) {
            if (0 === strpos($pathinfo, '/registro/frm_update_')) {
                ...
                if ($pathinfo === '/registro/frm_update_expprofesional') {
                    return array (  '_controller' => 'proyectos\\hojaVidaBundle\\Controller\\ExpProfesionalController::direcAction',  '_route' => '_frm_update_expprofesional',);
                }
