 ...
 */
class TdCampos extends \proyectos\curriculoBundle\Entity\TdCampos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdCampo()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idCampo"];
        }
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'idCampo', 'descripcion', 'code', 'idItem');
    }
