 ...
 */
class Acreencias extends \proyectos\hojaVidaBundle\Entity\Acreencias implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkAcreencias()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkAcreencias"];
        }
        $this->__load();
        return parent::getPkAcreencias();
    }
    ...
    {
        return array('__isInitialized__', 'pkAcreencias', 'naturaleza', 'entidad', 'valor', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
