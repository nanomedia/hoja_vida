 ...
 */
class Antecedentes extends \proyectos\hojaVidaBundle\Entity\Antecedentes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkAntecedentes()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkAntecedentes"];
        }
        $this->__load();
        return parent::getPkAntecedentes();
    }
    ...
    {
        return array('__isInitialized__', 'pkAntecedentes', 'tipo', 'descripcion', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
