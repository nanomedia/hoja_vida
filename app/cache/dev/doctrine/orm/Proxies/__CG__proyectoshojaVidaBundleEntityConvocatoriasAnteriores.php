 ...
 */
class ConvocatoriasAnteriores extends \proyectos\hojaVidaBundle\Entity\ConvocatoriasAnteriores implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkConvAnteriores()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkConvAnteriores"];
        }
        $this->__load();
        return parent::getPkConvAnteriores();
    }

    public function setConvocatoria($convocatoria)
    {
        $this->__load();
        return parent::setConvocatoria($convocatoria);
    }
    ...
    {
        return array('__isInitialized__', 'pkConvAnteriores', 'convocatoria', 'plaza', 'etapa', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
