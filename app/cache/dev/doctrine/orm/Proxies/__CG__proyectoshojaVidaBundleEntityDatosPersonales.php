...
class DatosPersonales extends \proyectos\hojaVidaBundle\Entity\DatosPersonales implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'idDatPersonal', 'nombres', 'apellidos', 'lugarNac', 'fechaNac', 'edad', 'dni', 'discapacidad', 'certDiscapacidad', 'foto', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt');
    }
