 ...
 */
class DocDerecho extends \proyectos\hojaVidaBundle\Entity\DocDerecho implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkDocDerecho()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkDocDerecho"];
        }
        $this->__load();
        return parent::getPkDocDerecho();
    }
    ...
    {
        return array('__isInitialized__', 'pkDocDerecho', 'universidad', 'nivel', 'mension', 'anio', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatAcademicos');
    }
