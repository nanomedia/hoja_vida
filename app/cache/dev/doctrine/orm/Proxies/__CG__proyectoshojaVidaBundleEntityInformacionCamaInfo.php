 ...
 */
class InformacionCamaInfo extends \proyectos\hojaVidaBundle\Entity\InformacionCamaInfo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkInformacionCamaInfo()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkInformacionCamaInfo"];
        }
        $this->__load();
        return parent::getPkInformacionCamaInfo();
    }
    ...
    {
        return array('__isInitialized__', 'pkInformacionCamaInfo', 'descripcion', 'tipo', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
