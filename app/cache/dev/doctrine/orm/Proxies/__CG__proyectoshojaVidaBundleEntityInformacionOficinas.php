 ...
 */
class InformacionOficinas extends \proyectos\hojaVidaBundle\Entity\InformacionOficinas implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkProcesosInformacionOficinas()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkProcesosInformacionOficinas"];
        }
        $this->__load();
        return parent::getPkProcesosInformacionOficinas();
    }

    public function setIdOficina($idOficina)
    {
        $this->__load();
        return parent::setIdOficina($idOficina);
    }

    public function getIdOficina()
    {
        $this->__load();
        return parent::getIdOficina();
    }
    ...
    {
        return array('__isInitialized__', 'pkProcesosInformacionOficinas', 'idOficina', 'descripcion', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
