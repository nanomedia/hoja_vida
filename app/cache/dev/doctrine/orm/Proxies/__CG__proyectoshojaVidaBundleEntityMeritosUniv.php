 ...
 */
class MeritosUniv extends \proyectos\hojaVidaBundle\Entity\MeritosUniv implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkMeritosUnivDet()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkMeritosUnivDet"];
        }
        $this->__load();
        return parent::getPkMeritosUnivDet();
    }
    ...
    {
        return array('__isInitialized__', 'pkMeritosUnivDet', 'puesto', 'universidad', 'anio', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatAcademicos');
    }
