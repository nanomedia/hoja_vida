 ...
 */
class MovimientoMigratorio extends \proyectos\hojaVidaBundle\Entity\MovimientoMigratorio implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkMovimiento()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkMovimiento"];
        }
        $this->__load();
        return parent::getPkMovimiento();
    }
    ...
    {
        $this->__load();
        return parent::setDestinoProcedencia($destinoProcedencia);
    }

    public function getDestinoProcedencia()
    {
        $this->__load();
        return parent::getDestinoProcedencia();
    }
    ...
    {
        return array('__isInitialized__', 'pkMovimiento', 'tipo', 'fecha', 'destinoProcedencia', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
