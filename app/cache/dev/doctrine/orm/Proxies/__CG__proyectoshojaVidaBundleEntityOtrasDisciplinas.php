 ...
 */
class OtrasDisciplinas extends \proyectos\hojaVidaBundle\Entity\OtrasDisciplinas implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkOtrasDisc()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkOtrasDisc"];
        }
        $this->__load();
        return parent::getPkOtrasDisc();
    }
    ...
    {
        return array('__isInitialized__', 'pkOtrasDisc', 'universidad', 'nivel', 'mension', 'anio', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatAcademicos');
    }
