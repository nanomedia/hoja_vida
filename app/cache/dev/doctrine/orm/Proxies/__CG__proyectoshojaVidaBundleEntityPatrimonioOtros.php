 ...
 */
class PatrimonioOtros extends \proyectos\hojaVidaBundle\Entity\PatrimonioOtros implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkPatrimonioOtros()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkPatrimonioOtros"];
        }
        $this->__load();
        return parent::getPkPatrimonioOtros();
    }
    ...
    {
        return array('__isInitialized__', 'pkPatrimonioOtros', 'descripcion', 'valor', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
