 ...
 */
class ProdJurFiscal extends \proyectos\hojaVidaBundle\Entity\ProdJurFiscal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkProdJurFiscal()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkProdJurFiscal"];
        }
        $this->__load();
        return parent::getPkProdJurFiscal();
    }
    ...
    {
        $this->__load();
        return parent::setDetRespuesta($detRespuesta);
    }

    public function getDetRespuesta()
    {
        $this->__load();
        return parent::getDetRespuesta();
    }
    ...
    {
        return array('__isInitialized__', 'pkProdJurFiscal', 'respuesta', 'detRespuesta', 'pkExpProfesional', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
