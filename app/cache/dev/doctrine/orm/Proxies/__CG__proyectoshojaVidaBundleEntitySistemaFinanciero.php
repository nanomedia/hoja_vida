 ...
 */
class SistemaFinanciero extends \proyectos\hojaVidaBundle\Entity\SistemaFinanciero implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPkSistemaFinanciero()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["pkSistemaFinanciero"];
        }
        $this->__load();
        return parent::getPkSistemaFinanciero();
    }
    ...
    {
        return array('__isInitialized__', 'pkSistemaFinanciero', 'clase', 'entidad', 'valor', 'usuarioAudt', 'fechaAudt', 'ipAudt', 'estadoAudt', 'pkDatPostulante');
    }
