                    ...
                    <td>
                        <table width=\"70%\" class=\"table ui-widget ui-widget-content\">
                            <tr>
                                ...
                                <td>
                                    <textarea name=\"txtctrabajo[]\" class=\"info_textarea\"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class=\"ui-widget-header\">Cargo:</td>
                                <td>
                                    <textarea  name=\"txtcargo[]\" class=\"info_textarea\"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class=\"ui-widget-header\">Periodo</td>
                                <td><textarea name=\"txtperiodo[]\" class=\"info_textarea\"></textarea></td>
                            </tr>
                    ...
                    <td>
                        <table width=\"70%\" class=\"table ui-widget ui-widget-content\">
                            ...
                            <tr>
                                <td class=\"ui-widget-header\">Periodo</td>
                                <td>
                                    <textarea name=\"txtperiodo[]\" class=\"info_textarea\"></textarea>
                                </td>
                            </tr>
